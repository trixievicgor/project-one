...
export const LandingPage = () => {
  // Creating three refs for the infinite loop effect
  ...
  return (
    <Layout headerRight={headerButtons}>
      <section className="container flex flex-col max-w-screen flex-grow">
        ...
        {/* The Ticker Tape Section */}
        <div className="flex w-full overflow-hidden py-3 border-y-2 border-neutral-800 bg-black">
          {carouselRefs.map((ref, i) => (
            <MarketHighlight key={i} ref={ref} />
          ))}
        </div>
